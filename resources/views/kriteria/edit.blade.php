                ...
                <div class="p-6">
                    <form action="{{ route('kriteria.update', $kriterium->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="kode_kriteria" id="kode_kriteria" value="{{ old('kode_kriteria', $kriterium->kode_kriteria) }}" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white @error('kode_kriteria') border-red-500 @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_kriteria" id="nama_kriteria" value="{{ old('nama_kriteria', $kriterium->nama_kriteria) }}" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white @error('nama_kriteria') border-red-500 @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input type="number" name="bobot" id="bobot" value="{{ old('bobot', $kriterium->bobot) }}" 
                                    min="0" max="100" step="0.01"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white @error('bobot') border-red-500 @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-start p-4 border border-gray-200 rounded-lg hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700 {{ old('jenis', $kriterium->jenis) == 'benefit' ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-500' : '' }}">
                                    <div class="flex items-center h-5">
                                        <input id="benefit" type="radio" name="jenis" value="benefit" {{ old('jenis', $kriterium->jenis) == 'benefit' ? 'checked' : '' }}
                                ...
                                <div class="flex items-start p-4 border border-gray-200 rounded-lg hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700 {{ old('jenis', $kriterium->jenis) == 'cost' ? 'bg-orange-50 dark:bg-orange-900/20 border-orange-500' : '' }}">
                                    <div class="flex items-center h-5">
                                        <input id="cost" type="radio" name="jenis" value="cost" {{ old('jenis', $kriterium->jenis) == 'cost' ? 'checked' : '' }}
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="keterangan" id="keterangan" rows="3"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('keterangan') border-red-500 @enderror"
                                placeholder="Deskripsi kriteria (opsional)">{{ old('keterangan', $kriterium->keterangan) }}</textarea>
                            @error('keterangan')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
