                    ...
                    <form action="{{ route('atlet.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama') }}" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white @error('nama') border-red-500 @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex gap-4">
                                <div class="flex items-center">
                                    <input id="laki-laki" type="radio" name="jenis_kelamin" value="L" {{ old('jenis_kelamin') == 'L' ? 'checked' : '' }}
                                ...
                                <div class="flex items-center">
                                    <input id="perempuan" type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin') == 'P' ? 'checked' : '' }}
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input type="number" name="umur" id="umur" value="{{ old('umur', $atlet->umur ?? '') }}" min="5" max="30"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="cabang_olahraga" id="cabang_olahraga"
                                ...
                                <option value="Sepak Bola" {{ old('cabang_olahraga') == 'Sepak Bola' ? 'selected' : '' }}>Sepak Bola</option>
                                <option value="Basket" {{ old('cabang_olahraga') == 'Basket' ? 'selected' : '' }}>Basket</option>
                                <option value="Voli" {{ old('cabang_olahraga') == 'Voli' ? 'selected' : '' }}>Voli</option>
                                <option value="Bulutangkis" {{ old('cabang_olahraga') == 'Bulutangkis' ? 'selected' : '' }}>Bulutangkis</option>
                                <option value="Renang" {{ old('cabang_olahraga') == 'Renang' ? 'selected' : '' }}>Renang</option>
                                <option value="Atletik" {{ old('cabang_olahraga') == 'Atletik' ? 'selected' : '' }}>Atletik</option>
                                <option value="Pencak Silat" {{ old('cabang_olahraga') == 'Pencak Silat' ? 'selected' : '' }}>Pencak Silat</option>
                                <option value="Karate" {{ old('cabang_olahraga') == 'Karate' ? 'selected' : '' }}>Karate</option>
                                <option value="Taekwondo" {{ old('cabang_olahraga') == 'Taekwondo' ? 'selected' : '' }}>Taekwondo</option>
                                <option value="Lainnya" {{ old('cabang_olahraga') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="no_telepon" id="no_telepon" value="{{ old('no_telepon') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('no_telepon') border-red-500 @enderror"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="alamat" id="alamat" rows="3"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('alamat') border-red-500 @enderror"
